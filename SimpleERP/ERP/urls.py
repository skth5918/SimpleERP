...
urlpatterns = [	
    ...
    url(r'^sales/discount_apply/', sales.discount_apply,name='discount_apply'),
    url(r'^sales/salesitems_delete/', sales.salesitems_delete),
    url(r'^sales/salesinvocie_submit/',sales.salesinvocie_submit,name="salesinvocie_submit"),
    url(r'^sales/sales_item_detail/',sales.sales_item_detail,name="sales_item_detail"),
    url(r'^sales/item_edit_apply/',sales.item_edit_apply,name="item_edit_apply"),
    url(r'^sales/bill_print/(?P<id>[^/]*)/$',sales.bill_print,name="bill_print"),
    url(r'^sales/list/', sales.sales_list, name='sales_list'),
    #autocompletes
